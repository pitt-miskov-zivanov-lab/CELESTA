...
class BasicDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.is_ulb == False:
            # FIXME: is_ulb, random choose?
            # double-check defixmatch for compatibility
            ...
            if self.alg == 'pseudolabel' or self.alg == 'vat':
                ...
                if isinstance(target, np.ndarray):
                    return {'idx': idx, 'text': sen[0],  'text_s': sen[self.random_choose_sen()], 'label':target, 'is_ulb': True}
